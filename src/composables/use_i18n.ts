...
const messages: Record<Language, Record<string, string>> = {
    zh: {
        ...
        'tip.fast-variant':
            '山脉类记号的 lnz-1 基本列可能仍过慢, 部分山脉记号可切换基本列变体为 "fast", 便于更快搜索到指定表达式.',
        'reset.title': '重置记号',
        ...
        'mountain.panel': '山脉图面板',
        'mountain.expression': '表达式:',
        'mountain.input-equiv': '输入等价表示:',
        'mountain.draw-equiv': '绘图等价表示:',
        'mountain.none': '(该表达式没有山脉图)',
        'mountain.parse-error': '(表达式无法解析)',
        'mountain.no-from-display': '(当前输入等价表示无法解析文本)',
        'mountain.open-panel': '用面板查看山脉图',
        'mountain.click-hint': '点击显示山脉图面板',
    ...
    en: {
        ...
        'fs-variant.normal': 'short',
        'fs-variant.alternative': 'long',
        'fs-variant.short': 'lnz-1',
        'toolbar.reset': 'Reset',
        ...
        'tip.fast-variant':
            'The lnz-1 fundamental sequence of mountain notations may still be too slow; some mountain notations let you switch the FS variant to "fast", which makes it faster to search for a given expression.',
        ...
        'category-name.sdbms-test': 'Tentative Notations',
        'settings.more': '▼ More',
        'settings.less': '▲ Less',
        ...
        'diagram.use-equiv': 'Diagram uses equivalence:',
        'diagram.settings': 'Diagram settings',
        'mountain.panel': 'Mountain panel',
        'mountain.expression': 'Expression:',
        'mountain.input-equiv': 'Input equivalence:',
        'mountain.draw-equiv': 'Drawing equivalence:',
        'mountain.none': '(no mountain diagram for this expression)',
        'mountain.parse-error': '(cannot parse expression)',
        'mountain.no-from-display': '(the input equivalence cannot parse text)',
        'mountain.open-panel': 'View mountain diagram in a panel',
        'mountain.click-hint': 'Click to open the mountain panel',
