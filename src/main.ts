...
import { e0MN } from '@/notations/MN/e0MN.ts';
import { strong_e0MN } from '@/notations/MN/strong_e0MN.ts';
...
import { category_hypcos_w2mn, category_mn, category_ta0_mn } from '@/notations/MN/categories.ts';
import { category_smile_mn } from '@/notations/MN/SMN/categories.ts';
import { category_sdbms, category_sdbms_test } from '@/notations/MN/SDBMS/categories.ts';
...
import { S_omega_DBMS_v1 } from '@/notations/MN/SDBMS/S_omega_DBMS-v1.ts';
import { S_omega_DBMS_v2 } from '@/notations/MN/SDBMS/S_omega_DBMS-v2.ts';
import { UP1DBMS } from '@/notations/MN/UPMN/UP1DBMS.ts';
import { UP2DBMS_v2 } from '@/notations/MN/UPMN/UP2DBMS-v2.ts';
...
register_category(category_ta0_mn);
register_notation(e0MN);
register_notation(strong_e0MN);
...
register_category(category_sdbms_test);
